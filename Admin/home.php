          ...
          <?php if (isset($_GET['tahun'])){ ?>
            ...
            while ($data = mysqli_fetch_array($r)) { ?>
              <tr>
                ...
                <?php if($_SESSION['status'] == 1){
                  echo "<td>
                  <a href='#modal-edit' class='btn btn-success btn-small' id='custId' data-toggle='modal' data-id=".$data['id'].">Edit</a>
                  <a class='btn btn-danger' href='proses_hapus.php?id=".$data['id']."'>Hapus</a>
                  </td>";} ?>
