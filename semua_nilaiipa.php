...
include "koneksi.php";
include "session.php";
$query ="SELECT * FROM `nilai_ipa` ";
 // if (isset($_GET['nis'])) {
 //   $query ="SELECT * FROM nilai_ipa WHERE nis = '$_GET[nis]'";
 // }
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="nilai_ipa.php"><i class="fa fa-dashboard"></i>Pencarian Nilai</a></li>
  ...
  <p> Mohon Maaf Anda Tidak bisa Masuk ke Panel ini </p>
   <?php } ?>
